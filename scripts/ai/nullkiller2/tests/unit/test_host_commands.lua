...
assert(journal[7].name == "setTargetObject")
assert(journal[7].payload.objid == 96)
assert(journal[8].name == "setActive")
assert(journal[8].payload.hero == 97)
assert(journal[8].payload.x == 9)
assert(journal[9].name == "invalidatePathfinderData")
assert(journal[10].name == "resetObjectClusterizer")
assert(journal[11].name == "endTurn")
