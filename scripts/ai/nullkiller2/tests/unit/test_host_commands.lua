...
adapter:dismissCreature({ id = 96 }, 6)
...
assert(journal[8].name == "dismissCreature")
assert(journal[8].payload.army == 96)
assert(journal[8].payload.slot == 6)
assert(journal[9].name == "setTargetObject")
assert(journal[9].payload.objid == 96)
assert(journal[10].name == "setActive")
assert(journal[10].payload.hero == 97)
assert(journal[10].payload.x == 9)
assert(journal[11].name == "invalidatePathfinderData")
assert(journal[12].name == "resetObjectClusterizer")
assert(journal[13].name == "endTurn")
