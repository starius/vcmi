...
assert(journal[9].name == "dismissCreature")
assert(journal[9].payload.army == 98)
assert(journal[9].payload.slot == 3)
assert(journal[10].name == "setTargetObject")
assert(journal[10].payload.objid == 96)
assert(journal[11].name == "setActive")
assert(journal[11].payload.hero == 97)
assert(journal[11].payload.x == 9)
assert(journal[12].name == "invalidatePathfinderData")
assert(journal[13].name == "resetObjectClusterizer")
assert(journal[14].name == "endTurn")
