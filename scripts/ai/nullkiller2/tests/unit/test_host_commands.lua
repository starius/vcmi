...
assert(journal[11].name == "dismissCreature")
assert(journal[11].payload.army == 98)
assert(journal[11].payload.slot == 3)
assert(journal[12].name == "setTargetObject")
assert(journal[12].payload.objid == 96)
assert(journal[13].name == "setActive")
assert(journal[13].payload.hero == 97)
assert(journal[13].payload.x == 9)
assert(journal[14].name == "invalidatePathfinderData")
assert(journal[15].name == "resetObjectClusterizer")
assert(journal[16].name == "endTurn")
