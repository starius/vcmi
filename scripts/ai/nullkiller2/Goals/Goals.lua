-- Mirrors AI/Nullkiller2/Goals/Goals.h: central include point for goal modules.

return {
	AbstractGoal = require("Goals.AbstractGoal"),
	AdventureSpellCast = require("Goals.AdventureSpellCast"),
	BuildBoat = require("Goals.BuildBoat"),
	...
	ExecuteHeroChain = require("Goals.ExecuteHeroChain"),
