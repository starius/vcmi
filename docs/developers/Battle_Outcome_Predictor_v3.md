...
- the 250-pair runtime A/B is running on the remote idle build as PID 270174, output `/root/vcmi-nk-ratio-results/runtime-ab-250-samples15-planner1-20260711`, with samples 15, planning safe attack ratio 1.0, jobs 2, and runtime-simulation requirement enabled. This does not touch the live schema5 town collector build.
