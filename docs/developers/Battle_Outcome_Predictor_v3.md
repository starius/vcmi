...
- live 20k schema5 town-hero run, current shard-group snapshot (`schema5-mmai-town-hero-20k-20260711`):
  - at 230 shard groups / 11644 parsed rows, fallback-only all-wins simulation reached 95.65% held-out win/loss accuracy with 8 samples and 97.83% with 15/20 samples
  - 8/15/20 samples had 0 false-safe groups and 1 conservative false-unsafe group on the held-out split
