...
- `BattleSimulationEvaluator` is the server-owned call boundary. It currently validates requests and returns `NOT_AVAILABLE` until state-isolated repeated simulation is implemented.
