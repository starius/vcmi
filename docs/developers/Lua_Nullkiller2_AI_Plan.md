...
- hero-specific artifact equipment scoring, full Rewardable inspection, and richer live object inspection remain
  incomplete outside the deterministic `RewardEvaluator` helpers
