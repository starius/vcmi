...
struct RuntimeBattleSimulationStats
{
	...
	uint64_t planningScorePositive = 0;
	uint64_t planningScoreZero = 0;
};
...
RuntimeBattleSimulationStats runtimeBattleSimulationStatsSnapshot()
{
	...
	return RuntimeBattleSimulationStats{
		...
		planningStats.scorePositive,
		planningStats.scoreZero
	};
}
	...
	const RuntimeBattleSimulationStats & before)
{
	return RuntimeBattleSimulationStats{
		...
		after.planningScorePositive - before.planningScorePositive,
		after.planningScoreZero - before.planningScoreZero
	};
}
...
void logRuntimeBattleSimulationStats(PlayerColor playerID, const RuntimeBattleSimulationStats & stats, int configuredSamples)
{
	if(!stats.requests
		...
		&& !stats.planningScorePositive
		&& !stats.planningScoreZero)
		return;
